  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (let index = 0; index < data.length; index++) {
        ...
        <td class=\"text-center\" style=\"vertical-align: middle;\"><a class=\"badge badge-soft-danger mr-2\"><img src=\"landing/images/wall-clock.svg\" height=\"12\" class=\"mr-2\">" + data[index].ultimaA + "</a></td><td>\
