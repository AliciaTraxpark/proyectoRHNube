...
<div class="row page-title" style="padding-right: 20px;">
    ...
    <div class="col-md-2 text-left">
        <select class="form-control" placeholder="pais" name="pais" id="pais">
            ...
            @if($paises->id==173)
            <option class="" selected="true" value="{{$paises->id}}"
                >{{$paises->nombre}}</option>
            @else
    ...
    <div class="col-md-2 text-left">
        ...
        <select class="form-control" placeholder="Departamento"name="departamento"
            id="departamento" style="display: flex;">
    ...
    <div class="col-md-2">
        <button id="nuevoCalendario" type="submit" class="boton"
            style="font-size: 12px;padding: 4px">Nuevo</button>
    </div>
</div>
@endsection
...
<div id="myModalEliminarD" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#163552;">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <h5 class="modal-title" id="myModalLabel">¿Desea eliminar
                        días descanso?</h5>
                </form>
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" style="padding-right:
                            38px;">
                            <button type="button" id="eliminarDescanso"
                                name="eliminarDescanso" style="background-color:
                                #163552;" class="btn">Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" style="padding-right:
                            38px;">
                            <button type="button" id="guardarFeriado"
                                name="guardarFeriado" class="btn btn-secondary">Aceptar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" style="padding-right:
                            38px;">
                            <button type="button" id="eliminarNLaboral"
                                name="eliminarNLaboral" style="background-color:
                                #163552;" class="btn">Eliminar</button>
                        </div>
                    </div>
                </div>
...
<div id="myModalEliminarDdep" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #163552;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" style="padding-right:
                            ...
                            <button type="button" style="background-color:
                                #163552;" id="eliminarDescansodep"
                                name="eliminarDescansodep" class="btn">Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="myModalEliminarNdep" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #163552;">
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" style="padding-right:
                            38px;">
                            <button type="button" id="eliminarNLaboraldep"
                                name="eliminarNLaboraldep"
                                style="background-color: #163552;" class="btn">Eliminar</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="myModalEliminarFeriado" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #163552;">
                <h5 class="modal-title" id="myModalLabel"
                    style="color:#ffffff;font-size:15px">Día feriado de usuario</h5>
                <button type="button" class="close" data-dismiss="modal"
                    aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" style="padding-right:
                            38px;">
                            <button type="button" id="eliminarDiaferi"
                                name="eliminarDiaferi" style="background-color:
                                #163552;" class="btn">Eliminar</button>
                        </div>
                    </div>
                </div>
...
<div id="myModalEliminarFeriadoDep" class="modal fade" tabindex="-1"
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-5 text-right" style="padding-right:
                            38px;">
                            <button type="button" id="eliminarDiaferiDep"
                                name="eliminarDiaferiDep"
                                style="background-color: #163552;" class="btn">Eliminar</button>
                        </div>
                    </div>
                </div>
