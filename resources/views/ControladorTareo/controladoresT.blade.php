                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <option class="" value="{{$dispositivos->iddispositivos_tareo}}">{{$dispositivos->dispoT_descripUbicacion}}
                                                    @if ($dispositivos->dispoT_estado!=2)
                                                        (No confirmado)
                                                        @endif
                                                           </option>
                                                    @endforeach
...
@section('script')
    ...
    <script src="{{ asset('landing/js/controladTareoMenu.js') }}"></script>
