                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                {{-- <input type="text"
                                                    data-custom-class="form-control" id="fechaN" tabindex="3"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            {{-- <input type="text"
                                                data-custom-class="form-control" id="v_fechaN" data-format="YYYY-MM-DD"
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            {{-- <input type="text" class="form-control"
                                                id="v_fechaNV" data-custom-class="form-control" data-format="YYYY-MM-DD"
