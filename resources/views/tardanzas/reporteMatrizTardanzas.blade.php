...
<div class="row justify-content-center pt-5 pr-5 pl-5 pb-2">
    <div class="col-xl-4" style="padding-left: 2%;padding-right: 0%;">
        <div class="input-group col-xl-12 colR">
            ...
            <div class="pl-2">
                <button type="button" class="btn btn-sm" id="btnRecargaTabla" style="background-color: #163552;" onclick="javascript:buscarReporteT()"> <img src="{{asset('landing/images/loupe (1).svg')}}" height="18" class="text-center mb-1"></button>
            </div>
        </div>
    </div>
