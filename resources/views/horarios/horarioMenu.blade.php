                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row col-md-12">
                                            <select data-plugin="customselect" multiple id="selectEmpresarial"
                                                ...
                                                <option value="{{$cargos->idcargo}}">Cargo : {{$cargos->descripcion}}.
                                                </option>
                                                @endforeach
                                                @foreach ($local as $locales)
                                                <option value="{{$locales->idlocal}}">Local : {{$locales->descripcion}}.
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <form id="frmHor" action="javascript:registrarNuevoHorario()">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="custom-control custom-switch mb-2">
                                                <input type="checkbox" class="custom-control-input" id="SwitchTardanza">
