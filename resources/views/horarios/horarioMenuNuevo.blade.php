...
@section('content')
    ...
    <div class="row row-divided">
        <div class="col-md-12 col-xl-12">
            ...
            <div id="modalHorarioClonar" class="modal fade" role="dialog" aria-labelledby="myModalLabel"
                aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="font-size:12px!important;background: #ffffff;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="col-lg-5 col-form-label" style="font-weight: 600">Rango de fechas:</label>
                                        <input type="hidden" id="ID_START">
                                        <input type="hidden" id="ID_END">
                                        <div class="input-group col-md-7 text-center" style="padding-left: 0px;padding-right: 12px;"
                                            id="fechaSelec">
