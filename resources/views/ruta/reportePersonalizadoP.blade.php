        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-1 text-center">
                <button type="button" class="btn btn-sm mt-1" style="background-color: #163552;"
                    onclick="javascript:buscarCapturas()">
                    <img src="{{asset('landing/images/loupe (1).svg')}}" height="18"></button>
            </div>
        </div>
    </div> <!-- end col-->
</div>
                    ...
                    <table id="Reporte" class="table nowrap" style="font-size: 13px!important;width:100%;">
                        <thead style="background: #fafafa;" id="dias" style="width:100%!important">
                            <tr>
                                ...
                                <th class="text-center">Latitud Inicio</th>
                                <th class="text-center">Longitud Inicio</th>
                                <th class="text-center">Latitud Fin</th>
                                <th class="text-center">Longitud Fin</th>
                            </tr>
                        </thead>
                        <tbody id="datos">
                        </tbody>
...
<script src="{{asset('landing/js/reportePersonalizadoRutaSP.js')}}"></script>
