...
class EmpleadoController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $vinculacion = DB::table('vinculacion as v')
            ...
            ->select('v.id as idV', 'le.idEmpleado', 'le.licencia', 'le.id as idL', 'le.disponible', 'td.dispositivo_descripcion')
        ...
        foreach ($vinculacion as $lic) {
            array_push($vinculacionD, array("idVinculacion" => $lic->idV, "idLicencia" => $lic->idL, "licencia" => $lic->licencia, "disponible" => $lic->disponible, "dispositivoD" => $lic->dispositivo_descripcion));
        }
